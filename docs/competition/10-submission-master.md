...
本文档用于作为正式提交版主稿入口，统一收束 `docs/competition/` 下的各章节内容。正式导出为 PDF 时，建议按本文件给出的顺序进行合并。
...
1. `00-writing-guide.md`
2. `99-self-review.md`

## 提交版使用原则

1. 正文始终围绕同一主线展开：课程资料库是统一生成源，多模态内容是其外化结果。
2. 题目要求覆盖说明放在正文之后，用于证明方案完整性，不打断主叙事。
3. 导出 PDF 时，统一封面、目录、页眉页脚与编号格式。
