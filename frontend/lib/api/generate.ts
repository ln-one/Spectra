...
export type UpdateOutlineRequest = components["schemas"]["UpdateOutlineRequest"];
export type UpdateOutlineResponse = components["schemas"]["UpdateOutlineResponse"];
export type ResumeSessionRequest = components["schemas"]["ResumeSessionRequest"];
export type ResumeSessionResponse = components["schemas"]["ResumeSessionResponse"];
export type RegenerateSlideRequest = components["schemas"]["RegenerateSlideRequest"];
export type RegenerateSlideResponse = components["schemas"]["RegenerateSlideResponse"];
...
export const generateApi = {
  ...
  async resumeSession(sessionId: string, data?: ResumeSessionRequest): Promise<ResumeSessionResponse> {
    return request<ResumeSessionResponse>(`/generate/sessions/${sessionId}/resume`, {
      method: "POST",
  ...
  async updateOutline(sessionId: string, data: UpdateOutlineRequest): Promise<UpdateOutlineResponse> {
    return request<UpdateOutlineResponse>(`/generate/sessions/${sessionId}/outline`, {
      method: "PUT",
      body: JSON.stringify(data),
      autoIdempotency: true,
    });
  ...
  async confirmOutline(sessionId: string, data?: ConfirmOutlineRequest): Promise<ConfirmOutlineResponse> {
    return request<ConfirmOutlineResponse>(`/generate/sessions/${sessionId}/confirm`, {
      method: "POST",
      body: data ? JSON.stringify(data) : undefined,
      autoIdempotency: true,
    });
  ...
  async sendCommand(sessionId: string, data: GenerationSessionCommandRequest): Promise<GenerationSessionCommandResponse> {
    return request<GenerationSessionCommandResponse>(`/generate/sessions/${sessionId}/commands`, {
      method: "POST",
      body: JSON.stringify(data),
      autoIdempotency: true,
    });
