...
class TestToolCheckerErrors:
    ...
    def test_check_tools_all_installed(self):
        """测试所有工具已安装"""
        with patch('services.generation.tool_checker.check_marp_installed') as mock_marp:
            with patch('services.generation.tool_checker.check_pandoc_installed') as mock_pandoc:
