...
from eval.ppt_image_quality_audit import DIMENSIONS
...
def main() -> int:
    parser = argparse.ArgumentParser(description="PPT 插图质量前后对照评测")
    parser.add_argument(
        "--dataset",
        default="eval/ppt_image_quality_comparison_samples.json",
        help="前后对照样本路径",
    )
    parser.add_argument(
        "--output",
