      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li><Link href="#workflow" className="hover:text-foreground">流程</Link></li>
              <li><Link href="#" className="hover:text-foreground">定价</Link></li>
            </ul>
          </div>
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li><Link href="#" className="hover:text-foreground">教程</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li><Link href="#" className="hover:text-foreground">联系方式</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li><Link href="#" className="hover:text-foreground">使用条款</Link></li>
              <li><Link href="#" className="hover:text-foreground">Cookie 政策</Link></li>
            </ul>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-muted-foreground">
          <div className="flex items-center gap-2">
            ...
            <span className="text-muted-foreground">© 2024 AI-powered courseware creation platform</span>
          </div>
