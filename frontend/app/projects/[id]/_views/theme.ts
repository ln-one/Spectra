...
function getStyleSurfaceVars(
  ...
  if (styleVariant === "ocean-cyan") {
    return {
      "--project-control-bg": "color-mix(in srgb, var(--project-surface-elevated) 74%, transparent)",
      "--project-control-bg-hover": "color-mix(in srgb, var(--project-surface) 66%, transparent)",
      "--project-control-border": "color-mix(in srgb, var(--project-border-strong) 68%, rgba(255,255,255,0.55))",
      "--project-control-text": "var(--project-text-primary)",
      "--project-control-muted": "var(--project-text-muted)",
      "--project-menu-bg": "color-mix(in srgb, var(--project-surface-elevated) 72%, rgba(255,255,255,0.4))",
      "--project-menu-border": "color-mix(in srgb, var(--project-border) 74%, rgba(255,255,255,0.5))",
      "--project-menu-shadow": "0 28px 56px -34px rgba(8, 64, 82, 0.5)",
      "--project-overlay": "rgba(5, 22, 35, 0.3)",
      "--project-success": "var(--project-accent)",
      "--project-success-soft": "color-mix(in srgb, var(--project-accent) 14%, white)",
  ...
  if (styleVariant === "teal-mint") {
    return {
      "--project-control-bg": "color-mix(in srgb, var(--project-surface-elevated) 82%, #edfffa)",
      "--project-control-bg-hover": "color-mix(in srgb, var(--project-surface-muted) 72%, #dafbf3)",
      "--project-control-border": "color-mix(in srgb, var(--project-border-strong) 72%, #7ad7ca)",
      "--project-control-text": "var(--project-text-primary)",
      "--project-control-muted": "var(--project-text-muted)",
      "--project-menu-bg": "color-mix(in srgb, var(--project-surface) 92%, #e3fbf7)",
      "--project-menu-border": "color-mix(in srgb, var(--project-border) 78%, #8bded2)",
  ...
  if (styleVariant === "ink-sky") {
    return {
      "--project-control-bg": "color-mix(in srgb, var(--project-surface-elevated) 94%, #e8f2ff)",
      "--project-control-bg-hover": "color-mix(in srgb, var(--project-surface-muted) 88%, #d8e8ff)",
      "--project-control-border": "color-mix(in srgb, var(--project-border-strong) 82%, #3768d8)",
      "--project-control-text": "var(--project-text-primary)",
      "--project-control-muted": "var(--project-text-muted)",
      "--project-menu-bg": "color-mix(in srgb, var(--project-surface) 95%, #e8f2ff)",
      "--project-menu-border": "color-mix(in srgb, var(--project-border) 82%, #6ea1ff)",
  ...
  if (styleVariant === "forest-emerald") {
    return {
      "--project-control-bg": "color-mix(in srgb, var(--project-surface-elevated) 96%, #f6edd8)",
      "--project-control-bg-hover": "color-mix(in srgb, var(--project-surface-muted) 95%, #efe2c6)",
      "--project-control-border": "color-mix(in srgb, var(--project-border-strong) 78%, #8c6a3f)",
      "--project-control-text": "var(--project-text-primary)",
      "--project-control-muted": "var(--project-caption)",
      "--project-menu-bg": "color-mix(in srgb, var(--project-surface) 95%, #f7ecd3)",
      "--project-menu-border": "color-mix(in srgb, var(--project-border) 76%, #9a774a)",
      "--project-menu-shadow": "0 20px 30px -24px rgba(121, 81, 28, 0.4)",
      "--project-overlay": "rgba(66, 37, 8, 0.24)",
      "--project-success": "var(--project-accent)",
      "--project-success-soft": "color-mix(in srgb, var(--project-accent) 18%, white)",
  ...
  if (styleVariant === "sand-ochre") {
    return {
      "--project-control-bg": "color-mix(in srgb, var(--project-surface-elevated) 94%, #fff3d9)",
      "--project-control-bg-hover": "color-mix(in srgb, var(--project-surface-muted) 93%, #f8eccf)",
      "--project-control-border": "color-mix(in srgb, var(--project-border-strong) 76%, #9d7c49)",
      "--project-control-text": "var(--project-text-primary)",
      "--project-control-muted": "var(--project-caption)",
      "--project-menu-bg": "color-mix(in srgb, var(--project-surface) 95%, #f6ebd1)",
      "--project-menu-border": "color-mix(in srgb, var(--project-border) 74%, #b89a68)",
  ...
  if (styleVariant === "sunset-amber") {
    return {
      "--project-control-bg": "color-mix(in srgb, var(--project-surface-elevated) 92%, #fff1e1)",
      "--project-control-bg-hover": "color-mix(in srgb, var(--project-surface-muted) 86%, #ffe3c4)",
      "--project-control-border": "color-mix(in srgb, var(--project-border-strong) 78%, #db7a32)",
      "--project-control-text": "var(--project-text-primary)",
      "--project-control-muted": "var(--project-caption)",
      "--project-menu-bg": "color-mix(in srgb, var(--project-surface) 93%, #ffe7cb)",
      "--project-menu-border": "color-mix(in srgb, var(--project-border) 80%, #e6965a)",
  ...
  if (styleVariant === "graphite-blue") {
    return {
      "--project-control-bg": "color-mix(in srgb, var(--project-surface-elevated) 92%, #0f172a)",
      "--project-control-bg-hover": "color-mix(in srgb, var(--project-surface-muted) 85%, #0f172a)",
      "--project-control-border": "var(--project-border-strong)",
      "--project-control-text": "var(--project-text-primary)",
      "--project-control-muted": "var(--project-text-muted)",
      "--project-menu-bg": "color-mix(in srgb, var(--project-surface) 90%, #0b1020)",
      ...
      "--project-success": "var(--project-accent)",
      "--project-success-soft": "color-mix(in srgb, var(--project-accent) 22%, white)",
      "--project-danger": "#ef4444",
      "--project-danger-soft": "rgba(239, 68, 68, 0.14)",
    };
  }
  ...
  if (styleVariant === "lavender-slate") {
    return {
      "--project-control-bg": "color-mix(in srgb, var(--project-surface-elevated) 90%, #f4edff)",
      "--project-control-bg-hover": "color-mix(in srgb, var(--project-surface-muted) 86%, #ece2ff)",
      "--project-control-border": "color-mix(in srgb, var(--project-border-strong) 78%, #8d66da)",
      "--project-control-text": "var(--project-text-primary)",
      "--project-control-muted": "var(--project-text-muted)",
      "--project-menu-bg": "color-mix(in srgb, var(--project-surface) 92%, #f3eaff)",
      "--project-menu-border": "color-mix(in srgb, var(--project-border) 78%, #a07be3)",
  ...
  if (styleVariant === "rose-wine") {
    return {
      "--project-control-bg": "color-mix(in srgb, var(--project-surface-elevated) 90%, #ffe9f0)",
      "--project-control-bg-hover": "color-mix(in srgb, var(--project-surface-muted) 86%, #ffd9e6)",
      "--project-control-border": "color-mix(in srgb, var(--project-border-strong) 78%, #cc4f82)",
      "--project-control-text": "var(--project-text-primary)",
      "--project-control-muted": "var(--project-text-muted)",
      "--project-menu-bg": "color-mix(in srgb, var(--project-surface) 92%, #ffe7ef)",
      "--project-menu-border": "color-mix(in srgb, var(--project-border) 78%, #d96a98)",
...
export function getProjectTheme(themeId: ThemePresetId): ProjectThemeDefinition {
  return getThemePresetDefinition(themeId);
}

export function getProjectThemeAttributes(themeId: ThemePresetId): ThemeStyleAttrs {
