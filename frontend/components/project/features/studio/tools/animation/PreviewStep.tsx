      ...
      <section className="rounded-xl border border-zinc-200 bg-white p-3">
        ...
        <div className="mt-3 flex items-start justify-between gap-2">
          <div className="flex items-center gap-2">
            ...
            <div>
              <p className="text-xs font-semibold text-zinc-800">动画预览（代码区 + 渲染区）</p>
        ...
        {hasBackendAnimation ? (
          <div className="mt-3 rounded-xl border border-emerald-200 bg-emerald-50/50 p-3">
            <p className="text-xs font-semibold text-emerald-700">后端动画内容预览</p>
            {backendHtml ? (
              <iframe
          ...
          <>
            ...
            >
              <div className="rounded-xl border border-zinc-900 bg-zinc-950 p-3">
                <p className="mb-2 text-[11px] text-zinc-300">动画代码（示意）</p>
                <pre className="overflow-x-auto text-[11px] leading-5 text-zinc-100">{codeText}</pre>
              </div>
